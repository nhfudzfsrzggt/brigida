...
local NotifyModule   = load("src/elements/Notify.lua") -- << LOAD NOTIFY MODULE
...
-- ╔══════════════════════════════════════════════════════════════════╗
-- ║   NOTIFY SYSTEM (EXTERNAL MODULE)                                ║
-- ╚══════════════════════════════════════════════════════════════════╝

function Chloex:MakeNotify(NotifyConfig)
    -- Memanggil module Notify.lua
    return NotifyModule:MakeNotify(TweenService, CoreGui, getIconId, NotifyConfig)
end
